...
Answer Q1 CORRECTNESS, Q2 COVERAGE BLIND SPOTS, Q3 DEAD CODE, Q4 DOCUMENTATION,
Q5 ERROR HANDLING, Q6 DRY VIOLATION, Q7 COMPLEXITY, Q8 SECURITY, Q9 PERFORMANCE, Q10 KONJO STANDARD.
BLOCKER for Q1/Q3/Q5/Q8 violations. WARNING for Q2/Q6/Q7/Q9.
...
def _call_api(diff_text: str, mod) -> dict:
    ...
    for attempt in range(MAX_RETRIES):
        ...
        except json.JSONDecodeError as e: raise ValueError(f"Non-JSON: {r.content[0].text}") from e
